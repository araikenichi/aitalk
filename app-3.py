...
if st.session_state["messages"]:
    ...
    for message in reversed(messages):
        ...
        speaker = f"<img src='{user_icon_url}' width='60' style='vertical-align: bottom;'>" if message["role"] == "user" else f"<img src='{bot_icon_url}' width='60' style='vertical-align: bottom;'>"
