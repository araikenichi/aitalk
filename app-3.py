...
if st.session_state["messages"]:
    ...
    for message in reversed(messages):
        if message["role"] == "user":
            speaker_icon = "<img src='https://user-images.githubusercontent.com/37874452/268952776-da20fb44-4303-4ebf-9335-9829e31c4f8c.png' width='60' style='vertical-align: middle;'>"
            message_align = "flex-end"
            text_align = "right"
            content_order = f"{speaker_icon}<span style='margin-left: 10px; text-align: {text_align};'>{message['content']}</span>"
        else:
            speaker_icon = "<img src='https://user-images.githubusercontent.com/37874452/268968551-3cb21d72-8e58-4eb9-894c-697f4b8147a7.png' width='60' style='vertical-align: middle;'>"
            message_align = "flex-start"
            text_align = "left"
            content_order = f"<span style='margin-right: 10px; text-align: {text_align};'>{message['content']}</span>{speaker_icon}"
